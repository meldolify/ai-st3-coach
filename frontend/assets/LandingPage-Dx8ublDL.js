...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:Ji,depthTest:!1,depthWrite:!1})}function XM(r,e,t){const n=new Float32Array(Xr),i=new j(0,1,0);return new vi({name:"SphericalGaussianBlur",defines:{n:Xr,CUBEUV_TEXEL_WIDTH:1/e,CUBEUV_TEXEL_HEIGHT:1/t,CUBEUV_MAX_MIP:`${r}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:n},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:Dl(),fragmentShader:`
		...
		`,blending:Ji,depthTest:!1,depthWrite:!1})}function ad(){return new vi({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:Dl(),fragmentShader:`
		...
		`,blending:Ji,depthTest:!1,depthWrite:!1})}function od(){return new vi({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Dl(),fragmentShader:`
